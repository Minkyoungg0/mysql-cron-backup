...
---
## 🚀 개요
데이터는 한 번 잃으면 되돌릴 수 없다는 여러 사례들을 보면서, **정기적인 자동 백업이 필수**라는 점을 깨달았다.<br>
특히 사람의 손에만 맡겨진 수동 백업은 결국 누락되기 쉽고, 실제 복구가 필요할 때는 아무 소용이 없는 경우가 많으므로,<br>
운영 환경에서 **안정성과 신뢰성을 보장하는 시스템**을 스스로 설계할 수 있는 능력을 기고자 하였다.<br>

> 🔍 참고 자료  
> - [국내 자동 백업 인식 조사 – CIO.com](https://www.cio.com/article/3854902/87%EA%B0%80-%EB%8D%B0%EC%9D%B4%ED%84%B0-%EB%B0%B1%EC%97%85%C2%B7%C2%B7%C2%B7-%EC%9B%A8%EC%8A%A4%ED%84%B4%EB%94%94%EC%A7%80%ED%84%B8-%EC%84%B8%EA%B3%84-%EB%B0%B1%EC%97%85%EC%9D%98-%EB%82%A0.html?utm_source=chatgpt.com)  
> - [카카오톡 백업 유효기간 사례 – Point News](https://point-news.com/38?utm_source=chatgpt.com)  

---

## 🎯 목표 

**정기적인 백업을 자동화**하여 **데이터 손실에 대비**하고,<br>
MySQL 데이터베이스를 대상으로 **Dump를 통해 압축**하고,**cron을 통해 주기적으로 실행**하며, <br>
운영 환경에서도 안정성과 신뢰성을 보장할 수 있는 체계를 구축하는 것이다.
